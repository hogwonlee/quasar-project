    ...
    <div class="q-pa-sm">
      {{
        selected_local.chinafood == '洽洽中国食品'
          ? '请确认收货地址是否在富川市。本店直接配送富川地区,免快递附加费用。(*附：活动期间由于订单过多，有可能延迟送货1~2天，敬请谅解！延迟情况将会短信告知。)'
          : '배송 주소가 부천인지 체크 바랍니다. 부천시는 직접 배달해드리기 때문에 배송부가비용은 빼드립니다.(*첨부: 이벤트 기간동안 주문이 많아서 배송이 1~2일 정도 지연될 수 있습니다. 부디 양해해주시길 바랍니다. 배송 상황에 대해서는 문자로 안내해드리겠습니다.)'
      }}
    </div>
    <q-toggle
      class="q-pa-sm"
