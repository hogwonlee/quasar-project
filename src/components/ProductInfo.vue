<template>
  <div>
    ...
    <div>
      <q-dialog v-model="card" class="justify-start q-gutter-none">
        ...
        <q-card class="my-card q-ma-none" style="height: 50%; width: 80%">
          <q-input
            class="col-12"
            readonly
            disable
        ...
        <q-page-sticky class="z-top" position="bottom" :offset="[-90, -60]">
          <q-btn
            class="z-top"
            stack
            rounded
