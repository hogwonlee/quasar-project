<template>
  <div class="q-pa-none q-ma-none text-black">
    ...
    <q-card class="transparent" flat>
      ...
      <q-card-section>
        <div>
          중국식품온라인은 (이하 "회사"는) 고객님의 개인정보를 중요시하며,
        ...
        <div class="text-body2 text-bold">가. 수집하는 개인정보의 항목</div>
        <div>
          o 회사는 회원가입, 상담, 서비스 신청 등을 위해 아래와 같은 개인정보를
          수집하고 있습니다.
        </div>
        <div>
          - 회원가입시 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 자택
          전화번호 , 휴대전화번호 , 이메일 , 14세미만 가입자의 경우 법정대리인의
          정보
        </div>
        <div>- 서비스 신청시 : 주소, 결제 정보</div>
        <div>
          o 서비스 이용 과정이나 사업 처리 과정에서 서비스이용기록, 접속로그,
          쿠키, 접속 IP, 결제 기록, 불량이용 기록이 생성되어 수집될 수 있습니다.
        </div>
        <div class="text-body2 text-bold">나. 수집방법</div>
        <div>
          - 홈페이지, 쇼핑몰 앱, 서면양식, 게시판, 이메일, 이벤트 응모,
          배송요청, 전화, 팩스, 생성 정보 수집 툴을 통한 수집
        </div>
        <div>- 쇼핑몰 앱 이용 시 : 기기정보(안드로이드, iOS)</div>
        <div></div>
        <div class="text-body1 text-bold">■ 개인정보의 수집 및 이용목적</div>
        <div>회사는 수집한 개인정보를 다음의 목적을 위해 활용합니다.</div>
        <div>o 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산</div>
        <div>
        ...
        <div>o 마케팅 및 광고에 활용</div>
        <div>
          이벤트 등 광고성 정보 전달 , 접속 빈도 파악 또는 회원의 서비스 이용에
          대한 통계
        </div>
        <div class="text-body1 text-bold">■ 개인정보의 보유 및 이용기간</div>
        <div>
        ...
        <div>
          회원이 탈퇴한 경우에도 불량회원의 부정한 이용의 재발을 방지, 분쟁해결
          및 수사기관의 요청에 따른 협조를 위하여, 이용계약 해지일로부터 10년간
          회원의 정보를 보유할 수 있습니다.
        </div>
        <div class="text-body2 text-bold">
        ...
        <div>o 계약 또는 청약철회 등에 관한 기록</div>
        <div>-보존이유 : 전자상거래등에서의소비자보호에관한법률</div>
        <div>-보존기간 : 5년</div>
        <div>o 대금 결제 및 재화 등의 공급에 관한 기록</div>
        <div>-보존이유: 전자상거래등에서의소비자보호에관한법률</div>
        <div>-보존기간 : 5년</div>
        <div>o 소비자 불만 또는 분쟁처리에 관한 기록</div>
        <div>-보존이유 : 전자상거래등에서의소비자보호에관한법률</div>
        <div>-보존기간 : 3년</div>
        <div>o 로그 기록</div>
        <div>-보존이유: 통신비밀보호법</div>
        <div>-보존기간 : 3개월</div>
        <div class="text-body1 text-bold">■ 개인정보의 파기절차 및 방법</div>
        <div>
        ...
        <div class="text-body1 text-bold">■ 개인정보 제공</div>
        <div>
          회사는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다. 다만,
          아래의 경우에는 예외로 합니다.
        </div>
        <div>o 이용자들이 사전에 동의한 경우</div>
        <div>
          o 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에
          따라 수사기관의 요구가 있는 경우
        </div>
        <div class="text-body1 text-bold">■ 수집한 개인정보의 위탁</div>
        <div>
          회사는 서비스 이행을 위해 아래와 같이 외부 전문업체에 위탁하여
          운영하고 있습니다.
        </div>
        <div>o 위탁 대상자 : [택배사 미정, 확정 후 예정]</div>
        <div>o 위탁업무 내용 : [택배사 위탁 내용]</div>
        <div>o 위탁 대상자 : [토스페이먼츠]</div>
        <div>o 위탁업무 내용 : [PG사 위탁 내용]</div>
        <div></div>
        <div class="text-body1 text-bold">
          ■ 이용자 및 법정대리인의 권리와 그 행사방법
        </div>
        <div>
          o 이용자는 언제든지 등록되어 있는 자신의 개인정보를 조회하거나 수정할
        ...
        <div>회사은(는) 다음과 같은 목적을 위해 쿠키를 사용합니다.</div>
        <div>o 쿠키 등 사용 목적</div>
        <div>
        ...
        <div class="text-body1 text-bold">■ 개인정보에 관한 민원서비스</div>
        <div>
          회사는 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기
          위하여 아래와 같이 관련 부서 및 개인정보보호책임자를 지정하고
          있습니다.
        </div>
        <div class="text-body2 text-bold">o 개인정보보호책임자</div>
        <div>성명 : 이호권</div>
        <div>소속 : 대표</div>
        <div>전화번호 : 010-8492-0526</div>
        <div>이메일 : hokwonlee88@gmail.com</div>
        <div>
        ...
        <div>
          o 기타 개인정보침해에 대한 신고나 상담이 필요하신 경우에는 아래 기관에
          문의하시기 바랍니다.
        </div>
        <div>개인정보침해신고센터 (privacy.kisa.or.kr / 국번 없이 118)</div>
        <div>개인정보분쟁조정위원회 (kopico.go.kr / 1833-6972)</div>
        <div>대검찰청 사이버수사과 (spo.go.kr / 지역번호+1301)</div>
