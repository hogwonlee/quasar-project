  ...
  <div class="q-pa-none q-ma-none text-black">
    ...
    <q-card class="transparent" flat>
      ...
      <q-card-section>
        ...
        <div></div>
        <div class="text-bold">제2조(정의)</div>
        <div>
        ...
        <div class="text-bold">제3조 (약관 등의 명시와 설명 및 개정)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제4조(서비스의 제공 및 변경)</div>
        ...
        <div></div>
        <div class="text-bold">제5조(서비스의 중단)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제6조(회원가입)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제7조(회원 탈퇴 및 자격 상실 등)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제8조(회원에 대한 통지)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제9조(구매신청 및 개인정보 제공 동의 등)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제10조 (계약의 성립)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제11조(지급방법)</div>
        <div>
        ...
        <div>3. 온라인무통장입금</div>
        <div>4. 전자화폐에 의한 결제</div>
        <div>5. 수령 시 대금지급</div>
        <div>6. 마일리지 등 “몰”이 지급한 포인트에 의한 결제</div>
        <div>7. “몰”과 계약을 맺었거나 “몰”이 인정한 상품권에 의한 결제</div>
        <div>8. 기타 전자적 지급 방법에 의한 대금 지급 등</div>
        <div></div>
        <div class="text-bold">제12조(수신확인통지․구매신청 변경 및 취소)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제13조(재화 등의 공급)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제14조(환급)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제15조(청약철회 등)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제16조(청약철회 등의 효과)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제17조(개인정보보호)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제18조(“몰“의 의무)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제19조(회원의 ID 및 비밀번호에 대한 의무)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제20조(이용자의 의무)</div>
        <div>이용자는 다음 행위를 하여서는 안 됩니다.</div>
        <div>1. 신청 또는 변경시 허위 내용의 등록</div>
        <div>2. 타인의 정보 도용</div>
        ...
        <div>6. “몰” 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위</div>
        <div>
          7. 외설 또는 폭력적인 메시지, 화상, 음성, 기타 공서양속에 반하는
          정보를 몰에 공개 또는 게시하는 행위
        </div>
        <div></div>
        <div class="text-bold">제21조(연결“몰”과 피연결“몰” 간의 관계)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제22조(저작권의 귀속 및 이용제한)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제23조(분쟁해결)</div>
        <div>
        ...
        <div></div>
        <div class="text-bold">제24조(재판권 및 준거법)</div>
        <div>
