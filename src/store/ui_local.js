const _ko = {
  ...
  claim_body:
    '(010)8492-0526 저에게 문자 또는 전화주세요. 빠른 시간내에 대응해드리고 서비스 개선하겠습니다.',
  ...
  event_5353_detail:
    '이벤트 기간동안 구매금액이 5만원을 초과할 경우, 3천원 쿠폰을 지급합니다. (다음번 구매할 때, 구매금액이 5만원 이상 구매 시 사용가능합니다. 받은 후 3개월(90일) 내에 사용하셔야 합니다.)',
  product_unit: '하나', //单个
...
const _cn = {
  ...
  claim_title: '申请退换',
  claim_body:
    '(010)8492-0526 如有问题，请联系或者发信息给我！我们将尽快解决问题并改善服务！',
  ...
  event_5353_detail:
    '活动期间内，如购买额超过5万韩元，则赠送3千韩元优惠券！下次购物时，购买额超过5万韩元，即可使用该优惠券。该优惠券的使用期限为3个月（90天）。',
  product_unit: '单个', //单个
